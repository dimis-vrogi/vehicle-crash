...
def load_and_prepare_data():
    ...
    data = {
        ...
        "Material": ["Κανένα","Κανένα","Κανένα","Κανένα","Κανένα","Κανένα","Κανένα","Μαλακό Αφρολέξ","Σκληρό Αφρολέξ","Φελιζόλ","Φελλός","Συνθετικό","Τσόχα","Τσόχα","Τσόχα","Τσόχα","Τσόχα","Τσόχα","Τσόχα","Τσόχα"],
